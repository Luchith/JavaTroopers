...
public class ManageInventoryService
{
    ...
    public boolean addProduct(String PID,String ProductName,String Price,String Category){
        try {
            String querry = "insert into Products (Product_ID,Product_Name, Price, Category) values('"+PID+"','"+ProductName+"','"+Price+"','"+Category+"')";
