...
public class empEmail extends JFrame {
        ...
        tblEmpNotfy.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow >= 0) {
                    ...
                    String orderCat = tblEmpNotfy.getValueAt(selectedRow, 3).toString();
    ...
    private boolean sendEmail(String recipient, String subject, String content) {
        ...
        final String username = "shipshape.oop@gmail.com";
        final String password = "bcbcowlupvjyqolt";
    ...
    void tableLoad() {
        try {
            pst = con.prepareStatement("SELECT emp.EmpEmail, cus.Order_ID, cus.CustomerName,  cus.OrderCategory FROM allocation alc JOIN customer_order cus ON alc.OID = cus.Order_ID JOIN employee emp ON alc.EID = emp.EmpID WHERE cus.Status = 'Allocate'");
