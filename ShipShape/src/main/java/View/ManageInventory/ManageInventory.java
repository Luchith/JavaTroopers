...
public class ManageInventory extends JFrame{
        ...
        ADDButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (ProductName.isEmpty() || ProductPrice.isEmpty() || ProductCategory.equals("")) {
                    ...
                    if(mng.addProduct(ganrateID(),ProductName,ProductPrice,ProductCategory)){
    ...
    String ganrateID()
    {
        ...
        int intid=0;
        try{
        pst = con.prepareStatement("select * from products ORDER BY Product_ID DESC LIMIT 1");
        ResultSet rs = pst.executeQuery();

            if (rs.next()) {
                 id = rs.getString(1);
                 intid=Integer.parseInt(id.substring(2));
                 intid++;
